...
const KEYS: SkyKey[] = [
  ...
  { e: 0, zenith: '#22417f', mid: '#a9788e', horizon: '#ff9457', ground: '#2a1d1a', sun: '#ff7132', sunI: 0.35 },
  { e: 6, zenith: '#2f66bd', mid: '#b892a6', horizon: '#f7ad68', ground: '#3d2f26', sun: '#ffb26a', sunI: 0.85 },
